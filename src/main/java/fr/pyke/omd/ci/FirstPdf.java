...
public class FirstPdf {
  ...
  /**
   * Add metadata to the PDF which can be viewed in your Adobe Reader under File
   * -> Properties.
   * 
  ...
  /**
   * Add a new title page to the PDF
   * 
   * @param document : a Document
  ...
  /**
   * Add a new empty line to a paragraph.
   * 
